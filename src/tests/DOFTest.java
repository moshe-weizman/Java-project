...
public class DOFTest {
	...
	// scene.addLightSource(new PointLight(new Color(80, 70, 30), new Point3D(0, 150, -400),0.0001, 0.000000001));
	 ...
	 ImageWriter imageWriter = new ImageWriter("   ספרות", 500, 500, 500, 500);
...
//-----------------------------------------------------------------------------------
	 ...
	 ImageWriter imageWriter = new ImageWriter(" חדר 2", 500, 500, 500, 500);
...
//---------------------------------------------------------------------
	 ...
	 ImageWriter imageWriter = new ImageWriter(" חדר 3", 500, 500, 500, 500);
...
//-----------------------------------------------------------------
	 ...
	 ImageWriter imageWriter = new ImageWriter("אקווריום 1", 500, 500, 500, 500);
...
//--------------------------------------------------------------------------------
	...
	// new Point3D(-150, 210, 500));
	 ...
	 ImageWriter imageWriter = new ImageWriter("הספירות בהרחקת הפוקוס אל האדום", 500, 500, 500, 500);
	 ...
	 */
	 ...
	 ImageWriter imageWriter = new ImageWriter("   בעזרת השם נעשה ונצליח", 500, 500, 500, 500);
